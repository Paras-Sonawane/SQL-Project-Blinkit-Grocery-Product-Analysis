...
8. 8. Write an SQL query to show count of Item_Fat_Content WHERE Item_Fat_Content is Regular.
...
33. 33. Write an SQL query to Average MRP by Outlet_Type and ordered in ascending order.
